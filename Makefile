...
help:
	...
	@echo "  dirs             Create build directories only"
	@echo ""
	...
	@echo "  octypes          Fetch/build OCTypes dependency only"
	@echo "  sitypes          Fetch/build SITypes dependency only"
	@echo "  update-deps      Update dependencies (clean + fetchlibs)"
	@echo "  clean-third-party Clean only third-party dependencies"
	@echo ""
	@echo "Testing:"
	@echo "  test             Run core tests (fast)"
	@echo "  test-imports     Run import tests (slow)"
	@echo "  test-csdm        Run CSDM-specific tests"
	@echo "  test-all         Run core+imports (comprehensive)"
	@echo "  test-asan        Core tests under AddressSanitizer (OC_LEAK_TRACKING=1)"
	@echo "  test-imports-asan Import tests under AddressSanitizer"
	@echo ""
	@echo "Documentation:"
	@echo "  docs             Build Doxygen+Sphinx HTML docs"
	@echo "  doxygen          Build Doxygen docs only"
	@echo "  html             Build HTML docs (alias for doxygen)"
	@echo ""
	@echo "Installation:"
	...
	@echo "  xcode-open       Generate Xcode workspace and open it"
	@echo "  xcode-run        Generate Xcode workspace and run"
	@echo ""
	@echo "Cleanup:"
