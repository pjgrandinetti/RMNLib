...
DatasetRef DatasetImportTecmagCreateWithFileData(OCDataRef contents, OCStringRef *error) {
    ...
    OCMutableDictionaryRef tecmagDataSetApplicationMetaData = OCDictionaryCreateMutable(0);
    OCDictionarySetValue(tecmagDataSetApplicationMetaData, STR("versionID"), versionIDString);
    OCRelease(versionIDString);
    OCMutableDictionaryRef tmagMetaData = CreateTecmagStructureMetaData(tecmag, error);
    OCDictionarySetValue(tecmagDataSetApplicationMetaData, STR("tmag"), tmagMetaData);
    ...
    // Create metadata
    OCMutableDictionaryRef nmrDataSetApplicationMetaData = OCDictionaryCreateMutable(0);
    OCDictionarySetValue(nmrDataSetApplicationMetaData, STR("Tecmag"), tecmagDataSetApplicationMetaData);
    OCRelease(tecmagDataSetApplicationMetaData);
    OCMutableDictionaryRef dataSetApplicationMetaData = OCDictionaryCreateMutable(0);
    OCDictionarySetValue(dataSetApplicationMetaData, STR("NMR"), nmrDataSetApplicationMetaData);
    OCRelease(nmrDataSetApplicationMetaData);
    ...
    OCDictionarySetValue(dataSetApplicationMetaData, kSIQuantityTemperature, metaCoordinate);
    ...
    OCDictionarySetValue(dataSetApplicationMetaData, kSIQuantityMagneticFluxDensity, metaCoordinate);
    OCRelease(metaCoordinate);
    DatasetSetApplicationMetaData(theDataset, dataSetApplicationMetaData);
    OCRelease(dataSetApplicationMetaData);
    OCRelease(theDependentVariable);
    free(tecmag);
    free(tecmag2);
    return theDataset;
