...
extern "C"
{
    ...
    typedef struct __RMNSIDimension *RMNSIDimensionRef;
    ...
    /**
     * @defgroup RMNSIDimension RMNSIDimension
    ...
    /**
     * @brief Returns the registered OCTypeID for RMNSIDimension.
     * @ingroup RMNSIDimension
     * @return The OCTypeID corresponding to RMNSIDimension.
     */
    OCTypeID RMNSIDimensionGetTypeID(void);
     ...
     *
     * @return A new RMNSIDimensionRef on success, or NULL on failure due to invalid input or allocation.
     *
     * @ingroup RMNSIDimension
     */
    RMNSIDimensionRef RMNSIDimensionCreate(
        OCStringRef label,
        OCStringRef description,
        OCDictionaryRef metaData,
     ...
     * @ingroup RMNSIDimension
     * @param dim  An RMNSIDimensionRef.
     ...
     * @return     The RMNSIDimensionRef reciprocal, or NULL if none or dim is NULL.
     */
    RMNSIDimensionRef
     ...
     * @ingroup RMNSIDimension
     * @param dim  An RMNSIDimensionRef.
     * @param r    The RMNSIDimensionRef to use as reciprocal.  May be NULL.
     */
    bool RMNDimensionSetReciprocal(RMNDimensionRef dim,
                                   RMNSIDimensionRef r);

    /** @} */ // end of RMNSIDimension group
