...
OCTypeID
    SIMonotonicDimensionGetTypeID(void);
...
bool         SIMonotonicDimensionSetCoordinates(SIMonotonicDimensionRef dim,
                                                 OCArrayRef coords);
SIDimensionRef
             SIMonotonicDimensionGetReciprocal(SIMonotonicDimensionRef dim);
...
OCTypeID
    SILinearDimensionGetTypeID(void);
...
bool         SILinearDimensionSetFFT(SILinearDimensionRef dim,
                                     bool fft);
SIDimensionRef
             SILinearDimensionGetReciprocal(SILinearDimensionRef dim);
...
OCStringRef  CreateLongDimensionLabel(DimensionRef dim,
                                      OCIndex    index);
